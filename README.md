[![Run App Jeffrey Church](https://github.com/JeffChurch22/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/JeffChurch22/GithubActions/actions/workflows/run-app.yaml)
